...
@section('title', 'Modifier un produit - ShoeStore Admin')

@section('content')
<div class="max-w-6xl mx-auto">
    <!-- Header -->
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900 mb-2">Modifier un produit</h1>
        <p class="text-gray-600">Mettez à jour les informations du produit</p>
    </div>

    <!-- Form -->
    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
        <form action="{{ route('admin.products.update', $product->id) }}" method="POST" class="space-y-8" onsubmit="return validateForm()">
            @csrf
            @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="name" name="name" required
                               ...
                               placeholder="Ex: Nike Air Max 90" value="{{ old('name', $product->name) }}">
                        @error('name')
                    ...
                    <div>
                        ...
                        <input type="text" id="slug" name="slug"
                               class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors"
                               placeholder="ex: nike-air-max-90" value="{{ old('slug', $product->slug) }}">
                    ...
                    <div>
                        ...
                        <select id="brand" name="brand" required
                            ...
                            <option value="New Balance" {{ old('brand', $product->brand) == 'New Balance' ? 'selected' : '' }}>New Balance</option>
                            ...
                            <option value="Reebok" {{ old('brand', $product->brand) == 'Reebok' ? 'selected' : '' }}>Reebok</option>
                            <option value="Autre" {{ old('brand', $product->brand) == 'Autre' ? 'selected' : '' }}>Autre</option>
                        </select>
                        @error('brand')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="number" id="price" name="price" required step="0.01" min="0"
                               class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors"
                               placeholder="129.99" value="{{ old('price', $product->price) }}">
                        @error('price')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
                        ...
                        <label class="cursor-pointer group">
                            <input type="checkbox" name="colors[]" value="Noir" class="sr-only peer" {{ in_array('Noir', old('colors', $productColors)) ? 'checked' : '' }}>
                        ...
                        <!-- White -->
                        <label class="cursor-pointer group">
                            <input type="checkbox" name="colors[]" value="Blanc" class="sr-only peer" {{ in_array('Blanc', old('colors', $productColors)) ? 'checked' : '' }}>
                            <div class="relative p-4 border-2 border-gray-200 rounded-lg peer-checked:border-indigo-500 peer-checked:bg-indigo-50 transition-all hover:border-gray-300">
                                <div class="flex flex-col items-center space-y-2">
                        ...
                        <!-- Red -->
                        <label class="cursor-pointer group">
                            <input type="checkbox" name="colors[]" value="Rouge" class="sr-only peer" {{ in_array('Rouge', old('colors', $productColors)) ? 'checked' : '' }}>
                            <div class="relative p-4 border-2 border-gray-200 rounded-lg peer-checked:border-indigo-500 peer-checked:bg-indigo-50 transition-all hover:border-gray-300">
                                <div class="flex flex-col items-center space-y-2">
                        ...
                        <!-- Blue -->
                        <label class="cursor-pointer group">
                            <input type="checkbox" name="colors[]" value="Bleu" class="sr-only peer" {{ in_array('Bleu', old('colors', $productColors)) ? 'checked' : '' }}>
                            <div class="relative p-4 border-2 border-gray-200 rounded-lg peer-checked:border-indigo-500 peer-checked:bg-indigo-50 transition-all hover:border-gray-300">
                                <div class="flex flex-col items-center space-y-2">
                        ...
                        <!-- Green -->
                        <label class="cursor-pointer group">
                            <input type="checkbox" name="colors[]" value="Vert" class="sr-only peer" {{ in_array('Vert', old('colors', $productColors)) ? 'checked' : '' }}>
                            <div class="relative p-4 border-2 border-gray-200 rounded-lg peer-checked:border-indigo-500 peer-checked:bg-indigo-50 transition-all hover:border-gray-300">
                                <div class="flex flex-col items-center space-y-2">
                        ...
                        <!-- Yellow -->
                        <label class="cursor-pointer group">
                            <input type="checkbox" name="colors[]" value="Jaune" class="sr-only peer" {{ in_array('Jaune', old('colors', $productColors)) ? 'checked' : '' }}>
                            <div class="relative p-4 border-2 border-gray-200 rounded-lg peer-checked:border-indigo-500 peer-checked:bg-indigo-50 transition-all hover:border-gray-300">
                                <div class="flex flex-col items-center space-y-2">
                        ...
                        <!-- Purple -->
                        <label class="cursor-pointer group">
                            <input type="checkbox" name="colors[]" value="Violet" class="sr-only peer" {{ in_array('Violet', old('colors', $productColors)) ? 'checked' : '' }}>
                            <div class="relative p-4 border-2 border-gray-200 rounded-lg peer-checked:border-indigo-500 peer-checked:bg-indigo-50 transition-all hover:border-gray-300">
                                <div class="flex flex-col items-center space-y-2">
                        ...
                        <!-- Orange -->
                        <label class="cursor-pointer group">
                            <input type="checkbox" name="colors[]" value="Orange" class="sr-only peer" {{ in_array('Orange', old('colors', $productColors)) ? 'checked' : '' }}>
                            <div class="relative p-4 border-2 border-gray-200 rounded-lg peer-checked:border-indigo-500 peer-checked:bg-indigo-50 transition-all hover:border-gray-300">
                                <div class="flex flex-col items-center space-y-2">
                        ...
                        <!-- Pink -->
                        <label class="cursor-pointer group">
                            <input type="checkbox" name="colors[]" value="Rose" class="sr-only peer" {{ in_array('Rose', old('colors', $productColors)) ? 'checked' : '' }}>
                            <div class="relative p-4 border-2 border-gray-200 rounded-lg peer-checked:border-indigo-500 peer-checked:bg-indigo-50 transition-all hover:border-gray-300">
                                <div class="flex flex-col items-center space-y-2">
                        ...
                        <!-- Gray -->
                        <label class="cursor-pointer group">
                            <input type="checkbox" name="colors[]" value="Gris" class="sr-only peer" {{ in_array('Gris', old('colors', $productColors)) ? 'checked' : '' }}>
                            <div class="relative p-4 border-2 border-gray-200 rounded-lg peer-checked:border-indigo-500 peer-checked:bg-indigo-50 transition-all hover:border-gray-300">
                                <div class="flex flex-col items-center space-y-2">
                        ...
                        <!-- Brown -->
                        <label class="cursor-pointer group">
                            <input type="checkbox" name="colors[]" value="Marron" class="sr-only peer" {{ in_array('Marron', old('colors', $productColors)) ? 'checked' : '' }}>
                            <div class="relative p-4 border-2 border-gray-200 rounded-lg peer-checked:border-indigo-500 peer-checked:bg-indigo-50 transition-all hover:border-gray-300">
                                <div class="flex flex-col items-center space-y-2">
                        ...
                        <!-- Navy -->
                        <label class="cursor-pointer group">
                            <input type="checkbox" name="colors[]" value="Marine" class="sr-only peer" {{ in_array('Marine', old('colors', $productColors)) ? 'checked' : '' }}>
                            <div class="relative p-4 border-2 border-gray-200 rounded-lg peer-checked:border-indigo-500 peer-checked:bg-indigo-50 transition-all hover:border-gray-300">
                                <div class="flex flex-col items-center space-y-2">
                        ...
                        <!-- Custom Color -->
                        <label class="cursor-pointer group">
                            <input type="checkbox" name="colors[]" value="Personnalisé" class="sr-only peer" {{ in_array('Personnalisé', old('colors', $productColors)) ? 'checked' : '' }}>
                            <div class="relative p-4 border-2 border-gray-200 rounded-lg peer-checked:border-indigo-500 peer-checked:bg-indigo-50 transition-all hover:border-gray-300">
                                <div class="flex flex-col items-center space-y-2">
                    ...
                    <div class="mt-4 p-4 bg-indigo-50 border border-indigo-200 rounded-lg">
                        <label class="flex items-center cursor-pointer">
                            <input type="checkbox" name="all_colors" value="1" class="mr-3 h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded" {{ old('all_colors') == '1' ? 'checked' : '' }}>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3 mb-4">
                            @php
                                $productSizes = array_map('trim', explode(',', $product->size));
                            @endphp
                            
                            <!-- 36 -->
                            <label class="cursor-pointer group">
                                <input type="checkbox" name="size[]" value="36" class="sr-only peer" {{ in_array('36', old('size', $productSizes)) ? 'checked' : '' }}>
                            ...
                            <!-- 37 -->
                            <label class="cursor-pointer group">
                                <input type="checkbox" name="size[]" value="37" class="sr-only peer" {{ in_array('37', old('size', $productSizes)) ? 'checked' : '' }}>
                                <div class="relative p-3 border-2 border-gray-200 rounded-lg peer-checked:border-indigo-500 peer-checked:bg-indigo-50 peer-checked:text-indigo-700 transition-all hover:border-gray-300 text-center">
                            ...
                            <!-- 38 -->
                            <label class="cursor-pointer group">
                                <input type="checkbox" name="size[]" value="38" class="sr-only peer" {{ in_array('38', old('size', $productSizes)) ? 'checked' : '' }}>
                                <div class="relative p-3 border-2 border-gray-200 rounded-lg peer-checked:border-indigo-500 peer-checked:bg-indigo-50 peer-checked:text-indigo-700 transition-all hover:border-gray-300 text-center">
                            ...
                            <!-- 39 -->
                            <label class="cursor-pointer group">
                                <input type="checkbox" name="size[]" value="39" class="sr-only peer" {{ in_array('39', old('size', $productSizes)) ? 'checked' : '' }}>
                                <div class="relative p-3 border-2 border-gray-200 rounded-lg peer-checked:border-indigo-500 peer-checked:bg-indigo-50 peer-checked:text-indigo-700 transition-all hover:border-gray-300 text-center">
                            ...
                            <!-- 40 -->
                            <label class="cursor-pointer group">
                                <input type="checkbox" name="size[]" value="40" class="sr-only peer" {{ in_array('40', old('size', $productSizes)) ? 'checked' : '' }}>
                                <div class="relative p-3 border-2 border-gray-200 rounded-lg peer-checked:border-indigo-500 peer-checked:bg-indigo-50 peer-checked:text-indigo-700 transition-all hover:border-gray-300 text-center">
                            ...
                            <!-- 41 -->
                            <label class="cursor-pointer group">
                                <input type="checkbox" name="size[]" value="41" class="sr-only peer" {{ in_array('41', old('size', $productSizes)) ? 'checked' : '' }}>
                                <div class="relative p-3 border-2 border-gray-200 rounded-lg peer-checked:border-indigo-500 peer-checked:bg-indigo-50 peer-checked:text-indigo-700 transition-all hover:border-gray-300 text-center">
                            ...
                            <!-- 42 -->
                            <label class="cursor-pointer group">
                                <input type="checkbox" name="size[]" value="42" class="sr-only peer" {{ in_array('42', old('size', $productSizes)) ? 'checked' : '' }}>
                                <div class="relative p-3 border-2 border-gray-200 rounded-lg peer-checked:border-indigo-500 peer-checked:bg-indigo-50 peer-checked:text-indigo-700 transition-all hover:border-gray-300 text-center">
                            ...
                            <!-- 43 -->
                            <label class="cursor-pointer group">
                                <input type="checkbox" name="size[]" value="43" class="sr-only peer" {{ in_array('43', old('size', $productSizes)) ? 'checked' : '' }}>
                                <div class="relative p-3 border-2 border-gray-200 rounded-lg peer-checked:border-indigo-500 peer-checked:bg-indigo-50 peer-checked:text-indigo-700 transition-all hover:border-gray-300 text-center">
                            ...
                            <!-- 44 -->
                            <label class="cursor-pointer group">
                                <input type="checkbox" name="size[]" value="44" class="sr-only peer" {{ in_array('44', old('size', $productSizes)) ? 'checked' : '' }}>
                                <div class="relative p-3 border-2 border-gray-200 rounded-lg peer-checked:border-indigo-500 peer-checked:bg-indigo-50 peer-checked:text-indigo-700 transition-all hover:border-gray-300 text-center">
                            ...
                            <!-- 45 -->
                            <label class="cursor-pointer group">
                                <input type="checkbox" name="size[]" value="45" class="sr-only peer" {{ in_array('45', old('size', $productSizes)) ? 'checked' : '' }}>
                                <div class="relative p-3 border-2 border-gray-200 rounded-lg peer-checked:border-indigo-500 peer-checked:bg-indigo-50 peer-checked:text-indigo-700 transition-all hover:border-gray-300 text-center">
                            ...
                            <!-- 46 -->
                            <label class="cursor-pointer group">
                                <input type="checkbox" name="size[]" value="46" class="sr-only peer" {{ in_array('46', old('size', $productSizes)) ? 'checked' : '' }}>
                                <div class="relative p-3 border-2 border-gray-200 rounded-lg peer-checked:border-indigo-500 peer-checked:bg-indigo-50 peer-checked:text-indigo-700 transition-all hover:border-gray-300 text-center">
                    ...
                    <div>
                        ...
                        <input type="number" id="stock_quantity" name="stock_quantity" required min="0"
                               class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors"
                               placeholder="50" value="{{ old('stock_quantity', $product->stock_quantity) }}">
            ...
            <div class="px-8 py-6 border-b border-gray-200">
                ...
                <div>
                    ...
                    <textarea id="description" name="description" required rows="6"
                              class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors"
                              placeholder="Décrivez les caractéristiques, matériaux, confort...">{{ old('description', $product->description) }}</textarea>
                    @error('description')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <input type="url" id="image_url_2" name="image_url_2"
                                   class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors"
                                   placeholder="https://example.com/image2.jpg" value="{{ old('image_url_2', $product->image_url_2) }}">
                        ...
                        <div>
                            ...
                            <input type="url" id="image_url_3" name="image_url_3"
                                   class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors"
                                   placeholder="https://example.com/image3.jpg" value="{{ old('image_url_3', $product->image_url_3) }}">
                            <p class="text-xs text-gray-500 mt-1">Optionnel</p>
                            @error('image_url_3')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="url" id="image_url_4" name="image_url_4"
                                   class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors"
                                   placeholder="https://example.com/image4.jpg" value="{{ old('image_url_4', $product->image_url_4) }}">
                            <p class="text-xs text-gray-500 mt-1">Optionnel</p>
                            @error('image_url_4')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
            ...
            <div class="px-8 py-6 border-b border-gray-200">
                ...
                <div class="space-y-6">
                    ...
                    <div id="promotionFields" class="space-y-4 {{ old('on_sale', $product->on_sale) ? '' : 'hidden' }}">
                        <!-- Sale Price -->
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="number" id="sale_price" name="sale_price" step="0.01" min="0"
                                       class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors"
                                       placeholder="89.99" value="{{ old('sale_price', $product->sale_price) }}">
                                @error('sale_price')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                                ...
                                <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                                    <div class="space-y-2">
                                        <div class="flex items-center justify-between">
                                            ...
                                            <span id="normalPricePreview" class="text-lg font-semibold text-gray-900">€{{ old('price', $product->price) }}</span>
                                        </div>
                                        <div class="flex items-center justify-between">
                                            <span class="text-sm text-gray-600">Prix promo:</span>
                                            <span id="salePricePreview" class="text-lg font-semibold text-green-600">€{{ old('sale_price', $product->sale_price ?: '0.00') }}</span>
                                        </div>
                        ...
                        <div>
                            ...
                            <textarea id="sale_description" name="sale_description" rows="3"
                                      class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors"
                                      placeholder="Ex: -20% pour l'été, Soldes exclusives, Offre limitée...">{{ old('sale_description', $product->sale_description) }}</textarea>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Show/hide promotion fields based on initial state
